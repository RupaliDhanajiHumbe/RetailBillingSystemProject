...
def Category():
    if Combo_Category.get()=="select Product":
        Combo_Category.current(0)
    if Combo_Category.get() =="Dove":
        Combo_Category.current(0)
    if Combo_Category.get() =="Lifeboy":
        Combo_Category.current(0)
    if Combo_Category.get() =="Sntur":
        Combo_Category.current(0)
def update_time():
...
def bill_area():
    if nameEntry.get()=='' or phoneEntry.get()=='':
        ...
        textarea.insert(END, f'\t\t           current_time')
...
searchButton=Button(Customer_details_frame,text='SEARCH'
                   ,font=('arial',12,'bold'),bd=7,width=18,command=search_bill)
...
Combo_Category=ttk.Combobox(cosmeticsFrame,state="readonly",font=('times new roman',14,'bold'))
Combo_Category.current(0)
Combo_Category.grid(row=0,column=1,pady=6,padx=10,sticky='w')
Combo_Category.bind("<<ComboboxSelected>>",Category)

bathsoapLabel=Label(cosmeticsFrame,text='Price',font=('times new roman',15,'bold'),bg='turquoise',fg='white')
bathsoapLabel.grid(row=0,column=2,pady=9,padx=10,sticky='w')
ComboProduct=ttk.Combobox(cosmeticsFrame,state="readonly",font=('times new roman',8,'bold'))
ComboProduct.grid(row=0,column=3,pady=1,padx=1,sticky='w')

bathsoapLabel=Label(cosmeticsFrame,text='Quantity',font=('times new roman',15,'bold'),bg='turquoise',fg='white')
bathsoapLabel.grid(row=0,column=4,pady=9,padx=10,sticky='w')
bathsoapEntry=Entry(cosmeticsFrame,font=('times new roman',15,'bold'),width=10,bd=5)
bathsoapEntry.grid(row=0,column=5,pady=9,padx=10)
bathsoapEntry.insert(0,0)
...
cosmeticTaxLabel=Label(BillmenuFrame,text='Cosmetic Tax',font=('times new roman',13,'bold')
                ,bg='turquoise',fg='white')
...
totalButton=Button(BillmenuFrame,text='Total',font=('arial',13,'bold'),bg='turquoise',fg='white',bd=5,width=8,pady=8
                   ,command=total)
...
billButton=Button(buttonFrame,text='Bill',font=('arial',16,'bold'),bg='turquoise',fg='white',bd=5,width=8,pady=10
                  ,command=bill_area)
billButton.grid(row=1,column=1,pady=20,padx=5)

emailButton=Button(buttonFrame,text='Email',font=('arial',16,'bold'),bg='turquoise',fg='white',
                   bd=5,width=8,pady=10,command=send_email)
emailButton.grid(row=1,column=2,pady=20,padx=5)

printButton=Button(buttonFrame,text='Print',font=('arial',16,'bold'),bg='turquoise',fg='white',
...
clearButton=Button(buttonFrame,text='Clear',font=('arial',16,'bold')
                   ,bg='turquoise',fg='white',bd=5,width=8,pady=10,command=clear)
